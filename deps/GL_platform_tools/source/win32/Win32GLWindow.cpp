...
namespace
{
	class WindowDCHandleSpace : public Win32::NullableHandleSpace<HDC, nullptr>
	{
		HWND hwnd;

	public:
		WindowDCHandleSpace(HWND hwnd)
			: hwnd(hwnd)
		{
		}

		void close(HDC hdc) const
		{
			Win32::assertClosed(ReleaseDC(hwnd, hdc));
		}
	};

	using unique_window_hdc = Win32::unique_handle<WindowDCHandleSpace>;
}
...
namespace Win32::GL
{
	...
	{
		unique_window_hdc hdc(GetDC(hwnd), hwnd);
	...
	namespace
	{
		::GL::platform::Key keycode(WPARAM wParam, LPARAM)
		{
