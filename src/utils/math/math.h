...
namespace math
{
	...
	template <> inline constexpr float pi<float> = 3.1415926535897932384626434f;
	template <> inline constexpr double pi<double> = 3.1415926535897932384626434;
	template <> inline constexpr long double pi<long double> = 3.1415926535897932384626434l;

	template <typename T> constexpr T e = cant_touch_this<T>::pi;
	template <> inline constexpr float e<float> = 2.7182818284590452353602875f;
	template <> inline constexpr double e<double> = 2.7182818284590452353602875;
	template <> inline constexpr long double e<long double> = 2.7182818284590452353602875l;
